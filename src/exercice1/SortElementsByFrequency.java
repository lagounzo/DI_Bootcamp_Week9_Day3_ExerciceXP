/**
 *  Exercice 1 : Trier Les Éléments Par Fréquence
 * Instructions
 * Imprimer les éléments d'un tableau dans la fréquence décroissante si 2 nombres ont la même fréquence puis imprimer celui
